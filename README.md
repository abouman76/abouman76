...
You can check out my repository's and see what i did so far. For example "Sociaal Oosterhout" which a social platform application and was build with React and Firebase as a "backend" database.
